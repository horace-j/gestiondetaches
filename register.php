            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="config.php">
                    <!-- Nom -->
                    <div class="col-12">
                    ...
                    <!-- Rôle -->
                    <div class="col-12">
                      <label for="yourRole" class="form-label">Rôle</label>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <div class="invalid-feedback">Vous devez accepter les conditions avant de soumettre.</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Vous avez déjà un compte ? <a href="pages-login.php">Se connecter</a></p>
                    </div>
                  </form>
                </div>
              </div>
