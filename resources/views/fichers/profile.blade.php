        ...
        <div class="col-xl-4">
            ...
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <img src="{{ asset('storage/' . $employer->image) }}" alt=" Profile" class="rounded-circle">
                    <h2>{{ $employer->prenom }} {{ $employer->nom }}</h2> <!-- Prenom et nom de l'employer -->
                    <h3>{{ $employer->profession }}</h3><!-- Le metier ou sa fonction dans entreprise -->
                    <div class="social-links mt-2">
                        <a style="font-size: 30px;" href="{{ $employer->mail }}" class="instagram"><i class="fa-solid fa-envelope " style="color: #888888;"></i></a> <!-- Lien de mail -->
                        <a style="font-size: 30px;" href="{{ $employer->lien_linkedin }}" class="linkedin "><i class="fa-brands fa-linkedin " style="color: #888888;"></i></a>
                    </div>
                </div>
            </div>
